...
| **Bedrock model access**                          | In the AWS console → **Bedrock → Model access**, enable the models in `config/models.yaml` for your region (default **Claude Opus 4.7** + **Claude Haiku 4.5**). **The #1 first-run gotcha** — without it the agent gets a 403. |
